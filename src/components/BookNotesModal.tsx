  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
      ...
      <motion.div
        ...
        className="relative w-full max-w-4xl bg-[var(--bg-secondary)] rounded-[2.5rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col max-h-[90vh] border border-[var(--border-color)]"
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 md:p-8 border-b border-[var(--border-color)] bg-[var(--bg-secondary)] shrink-0">
          ...
          <div className="bg-[var(--bg-primary)] rounded-3xl p-6 border-2 border-[var(--border-strong)] shadow-lg space-y-4 focus-within:border-[var(--accent-purple)] transition-all">
            <div className="flex flex-wrap gap-3">
              <select
                ...
                className="text-[10px] font-black bg-[var(--bg-hover)] border-none rounded-xl px-4 py-2.5 text-[var(--text-primary)] uppercase tracking-widest cursor-pointer focus:ring-1 focus:ring-[var(--accent-purple)]"
              >
              ...
              <input
                ...
                className="text-xs font-bold bg-[var(--bg-hover)] border-none rounded-xl px-4 py-2.5 text-[var(--text-primary)] w-48 placeholder:opacity-40 focus:ring-1 focus:ring-[var(--accent-purple)]"
              />
            </div>
            <textarea
              value={novaAnotacao}
        ...
        {/* Footer */}
        <div className="p-6 bg-[var(--bg-hover)] border-t border-[var(--border-color)] text-center shrink-0">
