...
export function MobilePillButton({
  ...
  return (
    <button
      type={type}
      className={cn(
        'inline-flex min-h-11 items-center justify-center rounded-full px-4 t-button transition-colors active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-40',
        TONE_CLASS[tone],
        className
      )}
      {...props}
