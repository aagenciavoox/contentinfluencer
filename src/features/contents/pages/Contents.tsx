...
import { ContentsMainTab, ContentsViewMode, SortDirection, SortField } from '../types';
...
export function Contents() {
  ...
  const handleAddContent = () => {
    // Reset filters to ensure the new content is visible
    ...
    <PageScaffold
      ...
      header={(
        <DesktopPageHeader
          section="Operação"
          title="Conteúdos"
          subtitle="Gerencie o estoque editorial, a evolução dos roteiros e os blocos de gravação no mesmo painel."
          icon={TableIcon}
          className="mb-0"
        />
      )}
